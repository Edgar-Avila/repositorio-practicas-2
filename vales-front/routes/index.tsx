import ProductosClientes from '@/pages/sistema/ProductosClientes'
import { lazy } from 'react'
import { Navigate, RouteProps } from 'react-router-dom'

// Dashboards
const AnalyticsDashboard = lazy(() => import('@/pages/dashboards/Analytics'))
const DatosEmpresa = lazy(() => import('@/pages/sistema/DatosEmpresa'))
const FichaDeContrato = lazy(() => import('@/pages/sistema/FichaDeContrato'))
const ListaClientes = lazy(() => import('@/pages/sistema/ListaClientes'))
const ListaContratos = lazy(() => import('@/pages/sistema/ListaContratos'))
const ListaDependencias = lazy(() => import('@/pages/sistema/ListaDependencias'))
const ListaDocumentos = lazy(() => import('@/pages/sistema/ListaDocumentos'))
const ListaEntidades = lazy(() => import('@/pages/sistema/ListaEntidades'))
const ListaProductos = lazy(() => import('@/pages/sistema/ListaProductos'))
const ListaVentas = lazy(() => import('@/pages/sistema/ListaVentas'))
const Mantenimiento = lazy(() => import('@/pages/sistema/Mantenimiento'))
const MiEntidad = lazy(() => import('@/pages/sistema/MiEntidad'))
const Perfil = lazy(() => import('@/pages/sistema/Perfil'))
const RegistroCliente = lazy(() => import('@/pages/sistema/RegistroCliente'))
const RegistroContrato = lazy(() => import('@/pages/sistema/RegistroContrato'))
const RegistroDependencia = lazy(() => import('@/pages/sistema/RegistroDependencia'))
const RegistroDocumento = lazy(() => import('@/pages/sistema/RegistroDocumento'))
const RegistroEntidad = lazy(() => import('@/pages/sistema/RegistroEntidad'))
const RegistroProducto = lazy(() => import('@/pages/sistema/RegistroProducto'))
const RegistroUsuario = lazy(() => import('@/pages/sistema/RegistroUsuario'))
const RegistroVenta = lazy(() => import('@/pages/sistema/RegistroVenta'))
const ReporteClientes = lazy(() => import('@/pages/sistema/ReporteClientes'))
const ReportePorProducto = lazy(() => import('@/pages/sistema/ReportePorProducto'))
const SalesDashboard = lazy(() => import('@/pages/dashboards/Sales'))
const Usuarios = lazy(() => import('@/pages/sistema/ListaUsuarios'))
...
const dashboardRoutes: RoutesProps[] = [
	...
	{
		path: '/sistema/productos/agregar',
	...
	{
		path: '/sistema/registro-clientes',
	...
	{
		path: '/sistema/registro-venta',
		name: 'Registro de Venta',
		element: <RegistroVenta />
	},
	{
		path: '/sistema/reporte-clientes',
		name: 'Reporte de Clientes',
		element: <ReporteClientes />
	},
	{
		path: '/sistema/reporte-productos',
		name: 'Reporte de Productos',
		element: <ReportePorProducto />
	},
	{
		path: '/sistema/entidades',
		name: 'Lista de Entidades',
		element: <ListaEntidades />
	},
	{
		path: '/sistema/contratos',
		name: 'Contratos',
		element: <ListaContratos />
	},
	{
		path: '/sistema/contratos/agregar',
		name: 'Agregar Contrato',
		element: <RegistroContrato />
	},
  {
  ...
  {
    path: '/sistema/contratos/:contratoId/ficha',
    name: 'Ficha de Contrato',
    element: <FichaDeContrato />
  },
	{
		path: '/sistema/entidades/:entidadId/dependencias',
		name: 'Lista de Dependencias',
		element: <ListaDependencias />
	},
  {
    path: '/sistema/entidades/:entidadId/dependencias/nuevo',
    name: 'Nueva Dependencia',
    element: <RegistroDependencia />
  },
	{
		path: '/sistema/entidades/mi-entidad',
		name: 'Mi Entidad',
		element: <MiEntidad />
	},
  {
    path: '/sistema/mantenimiento',
    name: 'Mantenimiento',
    element: <Mantenimiento />
  },
	{
		path: '/sistema/registro-entidad',
		name: 'Registro de Entidades',
		element: <RegistroEntidad />
	},
	{
	...
	{
		path: '/sistema/documentos/emitir',
		name: 'Emitir Documento',
		element: <RegistroDocumento />
	},
	{
	...
	{
		path: '/sistema/cliente/productos',
		name: 'Venta',
		element: <ProductosClientes />
	}
]
